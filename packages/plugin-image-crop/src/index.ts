...
export class ImageCropPlugin implements Plugin {
  name = 'image-crop';
  version = '1.0.0';
  
  private options: ImageCropPluginOptions;
  ...
  init(sightEdit: any): void {
    ...
    sightEdit.on('imageEditorReady', (editor: any) => {
